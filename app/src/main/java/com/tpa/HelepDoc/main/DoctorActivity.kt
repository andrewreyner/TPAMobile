...
import com.tpa.HelepDoc.adapters.DoctorAdapter
...
//        initDoctor()
    ...
    private fun initDoctor() {
        ...
        doctorRef.child(id!!).setValue(Doctor(id, "Hendra Suhendra", "hendra@gmail.com", "081234567890", "Male", "Dentist", 150000f))
        id = doctorRef.push().key
        doctorRef.child(id!!).setValue(Doctor(id, "Siti Sutarti", "siti@gmail.com", "081234567891", "Female", "General", 50000f))
        id = doctorRef.push().key
        doctorRef.child(id!!).setValue(Doctor(id, "Hani Ayunda", "hani@gmail.com", "081234567892", "Female", "Skin Care", 120000f))
        id = doctorRef.push().key
        doctorRef.child(id!!).setValue(Doctor(id, "Malik Sumalik", "malik@gmail.com", "081234567894", "Male", "General", 60000f))
